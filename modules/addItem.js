module.exports = async (client, message) => {
    ...
    if (target === "") return _.send({
        client,
        id: "additem no user, amount, and item entered",
    ...
    _.send({
        client,
        id: "additem item added",
        channel: message.channel,
        message: "{VAR1} now has {VAR2} more {VAR3}!",
        emoji: "white_check_mark",
        vars: [target, amount, item]
    });

    //Stats
    await _.stats(client, "Items Added");
};