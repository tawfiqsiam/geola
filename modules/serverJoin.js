module.exports = async (client, guild) => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .setDescription(`You need to set me up for this server! To do so, simply have a moderator visit [geolabot.com/me](http://geolabot.com/me) to access the Dashboard. I recommend starting in the "Main" section. If you have any questions, join my support server at https://discord.gg/eCDafVC and ask away in the \`#support\` channel!`)
