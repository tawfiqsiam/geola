module.exports = async (client, { id, language }) => {
    ...
    //Set translation
    translationLanguage.translation = translationLanguage.proposedTranslation.translator.translation || translationLanguage.proposedTranslation.user.translation;
