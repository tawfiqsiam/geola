module.exports = async (client, reaction, user) => {
    ...
    userData.devTranslator.messageType = "reject";

    //Send
    const message = await client.devTranslating.send(`:heavy_multiplication_x:  **|  ${user}, What is the reason for rejecting the translation? Say \`cancel\` to cancel**`);
    message.delete(5000);
