module.exports = async (client, reaction, user) => {
    ...
    userData.devTranslator.messageType = "blacklist";

    //Send
    const message = await client.devTranslating.send(`:eight_pointed_black_star:  **|  ${user}, What is the reason for blacklisting this user? Say \`cancel\` to cancel**`);
    message.delete(5000);
